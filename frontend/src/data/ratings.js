// src/data/ratings.js
// Dummy rating data — replace with API calls later

// Rating helper: status based on stars
...
// General ratings: keyed by productId -> ageGroup
